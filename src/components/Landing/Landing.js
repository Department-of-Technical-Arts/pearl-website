				...
				{/* <div className="landing-container" ref={elementRef}>
					<div className="landing-desc-container">
						<p className="landing-desc">
							...
							Hyderabad Campus. Incepted in 2009 as an intra-college festival, a
							year after the foundation of BITS Pilani, Hyderabad, the fest grew
							into a national level college cultural fest with participation
							from more than 50 colleges across India. This year's travel theme
							is just one more reason to look forward to the annual cultural
							fest that we know and adore.
							<br />
						</p>
